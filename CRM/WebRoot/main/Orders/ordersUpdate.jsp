...
<html>
  ...
  <body>
    <h1 align="center"><font color="red" face="隶书">订单修改</font></h1>
   	<hr/>
   		 <form action="<%=basePath%>OrdersServlet?action=updateSave" method="post" name="form1" onsubmit="return baocun();">
	  <div class="layui-form-item">
	    <label class="layui-form-label">订单编号</label>
	    <div class="layui-input-inline">
	    	 <input type="text" id="orderId" name="orderId" value="${o.orderId}" required  lay-verify="required" placeholder="请输入"  class="layui-input">
	    </div>
	   ...
	   <div class="layui-form-item">
	    ...
	    <div class="layui-input-inline">
	     <select name="orderType" required lay-verify="required" class="layui-input" autocomplete="off">
	    	<c:if test="${o.orderType=='采购入库'}">
		    	<option value="采购入库" selected >采购入库</option>
		        <option value="销售出库">销售出库</option>
	        </c:if>
	        <c:if test="${o.orderType=='销售出库'}">
	    ...
	    <div class="layui-input-inline">
	      <input type="text" id="process" name="process"  value="${o.process}"  class="layui-input">
	    </div>
	   </div>
	    <div class="layui-form-item">
	    <label class="layui-form-label">订单金额</label>
	    <div class="layui-input-inline">
	      <input type="text" id="totalMoney" name="totalMoney" value="${o.totalMoney}" required  lay-verify="required" placeholder="请输入名称"  class="layui-input">
	    </div>
	    
	    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	    开票时间：<input type="text" value="${o.oprtime }" name="oprtime" id="oprtime" style="width:200px;" class="easyui-datebox"">
    	
    	<label class="layui-form-label">开票人</label>
	    <div class="layui-input-inline">
	      <input type="text" id="operator" name="operator" value="${o.operator}" placeholder="请输入" required lay-verify="required" class="layui-input">
	    </div>
	  </div>
  	  <div class="layui-form-item">
	   <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <textarea type="text" id="remark" name="remark" value="${o.remark}" required  lay-verify="required" placeholder="请输入信息" autocomplete="off" class="layui-input"></textarea>
	    </div>
	  </div>
    	<div class="layui-input-block">
