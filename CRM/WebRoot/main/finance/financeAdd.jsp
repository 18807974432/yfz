...
<html>
  ...
  <body>
	 <br/><br/>
	 <form id="form1" action="<%=basePath%>financeServlet?action=add" method="post" name="form1" onsubmit="return baocun();">
		  		...
		  		<div class="layui-form-item">
		  			<label class="layui-form-label">应收金额:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="remainMoney" id="remainMoney" required  lay-verify="required" placeholder="必填" autocomplete="off" class="layui-input">
		   			</div>
		  			<label class="layui-form-label">收款金额:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="paidMoney" id="paidMoney" required  lay-verify="required" placeholder="必填" autocomplete="off" class="layui-input">
		   			</div>
		   			<label class="layui-form-label">订单金额:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="orderMoney" id="orderMoney" required  lay-verify="required" placeholder="必填" autocomplete="off" class="layui-input">
		   			</div>
		 		</div>
		 		...
		 		<div class="layui-form-item">
		  			<label class="layui-form-label">交款人:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="paidPerson" id="paidPerson" autocomplete="off" class="layui-input">
		   			</div>
		  			<label class="layui-form-label">入账银行:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="inbank" id="inbank" autocomplete="off" class="layui-input">
		   			</div>
		   			<label class="layui-form-label">入账账号:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="bankAccount" id="bankAccount" autocomplete="off" class="layui-input">
		   			</div>
		 		</div>
		 		...
		 		<div class="layui-form-item">
		  			<label class="layui-form-label">出账银行:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="outbank" id="outbank" autocomplete="off" class="layui-input">
		   			</div>
		  			<label class="layui-form-label">相关凭证号:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="warrant" id="warrant" autocomplete="off" class="layui-input">
		   			</div>
		   			交款时间：<input type="text" name="paidTime" id="paidTime" style="width:200px;" placeholder="必填" class="easyui-datebox"">
		 		</div>	
	 			
 			
		  		<div class="layui-form-item">
		  			到账日期：<input type="text" name="paidinTime" id="paidinTime" style="width:200px;" class="easyui-datebox"">
		 		
		  			<label class="layui-form-label">是否有效:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="invalid" id="invalid" autocomplete="off" class="layui-input">
		   			</div>
		   			<label class="layui-form-label">操作类别:</label>
		   			<div class="layui-input-inline">
		     			<input type="text" name="oprType" id="oprType" autocomplete="off" class="layui-input">
		   			</div>
		 		</div>
