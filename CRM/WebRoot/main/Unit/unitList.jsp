...
<head>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			$(pager).pagination({
				...
				onBeforeRefresh:function(p,s){
					location.href="${pageContext.request.contextPath }/UnitServlet?pager.cur_page="+p+"&pager.pageRow="+s;
				},
    	...
    	function edit(){
			...
			url = "${pageContext.request.contextPath }/UnitServlet?action=update&unitId="+arr;
			location.href=url;	
		}
		...
		//新增
		function add(){
			url = "${pageContext.request.contextPath }/main/Unit/unitAdd.jsp";
			location.href=url;
		}
		...
		function del(){
			...
			var url = "${pageContext.request.contextPath }/UnitServlet?action=del&prodid="+arr;
			location.href=url;	
		}
  	...
  	<table class="easyui-datagrid" border="1" pagination="true"  id="changesize" style="width:auto;padding:0px"  singleSelect="false"  datapagesize="onClickRow:getRowData" >
    	<thead>
    		<tr>
    			...
    			<th field="unitName" width=70 align="center">单位名称</th>
    		</tr>
    	</thead>
    	<tbody>
    	<!--  
