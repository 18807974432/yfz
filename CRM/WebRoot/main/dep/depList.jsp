  ...
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			$(pager).pagination({
				...
				onBeforeRefresh:function(p,s){
					location.href="${pageContext.request.contextPath }/DepServlet?pager.cur_page="+p+"&pager.pageRow="+s;
				},
    	...
    	function edit(){
			...
			url = "${pageContext.request.contextPath }/DepServlet?action=update&depid="+arr;
			location.href=url;	
		}
		...
		//新增
		function add(){
			url = "${pageContext.request.contextPath }/main/dep/depAdd.jsp";
			location.href=url;
		}
		...
		function del(){
			...
			var url = "${pageContext.request.contextPath }/DepServlet?action=del&depid="+arr;
			location.href=url;	
		}
  ...
  <c:if test="${dep eq 1}">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" BACKGROUND="images/maintitle.jpg" class="tablelist2">
  	...
  	<table class="easyui-datagrid" border="1" pagination="true"  id="changesize" style="width:auto;padding:0px"  singleSelect="false"  datapagesize="onClickRow:getRowData" >
    	<thead>
    		<tr>
    			<th field="id" checkbox="true"  width=80>部门编号</th>
    			<th field="username" width=70 align="center">部门名称</th>
    			<th field="depname" width=70 align="center">部门负责人</th>
    			<th field="jobname" width=100 align="center">部门描述</th>
    		</tr>
    	</thead>
    	<tbody>
    	<!--  
