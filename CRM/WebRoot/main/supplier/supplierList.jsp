  ...
  <head>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			$(pager).pagination({
				...
				onBeforeRefresh:function(p,s){
					location.href="${pageContext.request.contextPath }/SupplierServlet?pager.cur_page="+p+"&pager.pageRow="+s;
				},
    	...
    	function edit(){
			...
			url = "${pageContext.request.contextPath }/SupplierServlet?action=update&supplierId="+arr;
			location.href=url;	
		}
		...
		//新增
		function add(){
			url = "${pageContext.request.contextPath }/main/supplier/supplierAdd.jsp";
			location.href=url;
		}
		...
		function del(){
			...
			var url = "${pageContext.request.contextPath }/SupplierServlet?action=del&supplierId="+arr;
			location.href=url;	
		}
  ...
  <body>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" BACKGROUND="images/maintitle.jpg" class="tablelist2">
  	...
  	<table class="easyui-datagrid" border="1" pagination="true"  id="changesize" style="width:auto;padding:0px"  singleSelect="false"  datapagesize="onClickRow:getRowData" >
    	<thead>
    		<tr>
    			<th field="id" checkbox="true"  width=80>主键编码</th>
    			<th field="suppliername" width=70 align="center">供应商名称</th>
    			<th field="bankAccount" width=70 align="center">银行账号</th>
    			<th field="bankName" width=100 align="center">开户银行</th>
    			<th field="contact" width=70 align="center">联系人</th>
    			<th field="phone" width=70 align="center">电话</th>
    			<th field="addr" width=100 align="center">地址</th>
