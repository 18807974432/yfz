...
<html>
  ...
  <link rel="stylesheet" type="text/css" href="<%=basePath%>main/user/js/jquery-easyui-1.3.0/themes/default/easyui.css">
	...
	<body>
    <h2 align="center">新增商品信息</h2>
    <hr/>
    <form action="${pageContext.request.contextPath}/ProductServlet?action=add" method="post" name="form1" onsubmit="return check();">
    	<div class="layui-form-item"> 
    		<label class="layui-form-label">商品编号:</label>
    		<div class="layui-input-inline">
    			<input type="text" name="prodid" required lay-verify="required" class="layui-input">
			</div>
    		<label class="layui-form-label">商品名称:</label>
    		<div class="layui-input-inline">	
    			<input type="text" name="prodname" required lay-verify="required" class="layui-input">
    		</div>
    		<label class="layui-form-label">商品型号:</label>
    		<div class="layui-input-inline">
    			<input type="text" name="prodModel" class="layui-input">
    		</div>
    	</div>
    	<div class="layui-form-item"> 
    		...
    		<div class="layui-input-inline">
    			<input type="text" name="prodStyle" class="layui-input">
    		</div>
    		<label class="layui-form-label">库存数量:</label>
    		<div class="layui-input-inline">
    			<input type="text" name="prodCount" class="layui-input">
    		</div>
		</div>
		<div class="layui-form-item"> 
    		...
    		<div class="layui-input-inline">
    			<input type="text" name="lowSalePrice" class="layui-input">
    		</div>
    	</div>
    	<div class="layui-form-item"> 
    		<label class="layui-form-label">商品序列号:</label>
    		<div class="layui-input-inline">	
    			<input type="text" name="prodSerial" class="layui-input">
    		</div>
    		<label class="layui-form-label">商品CDKEY:</label>
    		<div class="layui-input-inline">	
    			<input type="text" name="cdKey" class="layui-input">
    		</div>
