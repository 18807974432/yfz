...
<div class="login-box">
    ...
    <form name="form1" method="post" action="usersAction!login.action" id="form1" onsubmit="return che()">
        <div class="login">
            <label>账  号：</label>
            <input name="user.username" type="text" maxlength="25" id="username" class="text-input" />
        </div>
        <div class="password">
            <label>密  码：</label>
            <input name="user.password" type="password" maxlength="25" id="password" class="text-input"/>
        </div>
        <div class="code">
            <label>验证码：</label>
        ...
        <div class="login">
            <button type="submit"  id="dl" style=" width: 250px" >登录系统</button>
        </div>
    </form>
</div>
<div class="loginbottom"></div>
<div style="width:100%; text-align:center;">
    <a href="http://www.sms98.cn/" target="_blank"><font color="#ffffff">软件官网</font></a>&nbsp;&nbsp;&nbsp;&nbsp;
    <font color="#ffffff">客服QQ:31343080&nbsp;&nbsp;&nbsp;&nbsp;
        版权所有@2014~2015</font>&nbsp;&nbsp;&nbsp;&nbsp;
    <font color="#ffffff">请使用IE6.0以上版本，在1366 x 768分辨率下使用效果最好。</font>
    <a href="media/readme.avi"><font color="#ffffff">使用视频下载</font></a>
</div>
<div class="screenbg">
    <ul>
